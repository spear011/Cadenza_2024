...
class SceneRenderer:
    ...
    def load_interferer_signals(self, scene):
        ...
        # NOTE: all interferer signals are assumed to by at the Clarity sr = 44100 Hz
    ...
    def generate_hoa_signals(self, scene: dict) -> tuple:
        ...
        # NOTE: Target signals assumed to be at the Clarity sample_rate = 44100 Hz
        ...
        target, _sample_rate = librosa.load(target_audio_path, sr=None)
