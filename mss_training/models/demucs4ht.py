...
from .demucs.filtering import wiener
from .demucs.band_hdemucs import BandHDemucs
...
def get_model(args):
    ...
    klass = {
        ...
        'hdemucs': HDemucs,
        'htdemucs': HTDemucs,
        'bs_hdemucs': BandHDemucs,
    }[args.model]

    # if args.model == "bs_hdemucs":
    #     extra['band_split'] = args.band_split
    #     extra['band_seq'] = args.band_seq
